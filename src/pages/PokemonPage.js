    ...
    return  (
        <>
            ...
            <Loader/>
                ...
                <>
                    <Row>
                        <div className={`pokemon-page-header background-${pokemonDetails.types[0].type.name}`} style={{backgroundImage: `url("/img/svg/${pokemonDetails.types[0].type.name}-bg.svg")`, backgroundSize: '100px'}}>
